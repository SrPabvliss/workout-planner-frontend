...
import type { Mail } from '@/core/layout/data/mails'	
...
import MailDisplay from './mail-display.vue'
import MailList from './mail-list.vue'
...
<template>
  <TooltipProvider :delay-duration="0">
    <ResizablePanelGroup
      ...
      class="h-full max-h-[calc(100vh)] items-stretch"
    >
      <ResizablePanel
        id="resize-panel-1"
